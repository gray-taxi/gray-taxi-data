# NYC Yellow Taxi 분석 및 ML 예측 자동화 보고서 (2026-05)
...
*상세 설명: 일별 시간대 중 오후 18~19시(퇴근 시간대)에 택시 수요가 가장 급증하며, 오전 7~8시(출근 시간대)에도 작은 피크가 형성되는 이중 피크 패턴이 나타납니다.*
...
* **인터랙티브 시각화 HTML (브라우저에서 직접 조작 가능)**:
  ...
  - [주행 거리 vs 기본 요금 산점도 (Interactive - 10k Samples)](file:///C:/Users/JMG/Desktop/skala/gray-taxi-data/outputs/trip_distance_vs_fare_interactive.html)
* **학습 완료된 파이프라인 파일 (.pkl)**:
  - [saved_models/taxi_fare_pipeline.pkl](file:///C:/Users/JMG/Desktop/skala/gray-taxi-data/saved_models/taxi_fare_pipeline.pkl)
* **분석 Jupyter Notebook**:
  - [notebooks/01_visualization.ipynb](file:///C:/Users/JMG/Desktop/skala/gray-taxi-data/notebooks/01_visualization.ipynb)
  - [notebooks/02_statistical_analysis.ipynb](file:///C:/Users/JMG/Desktop/skala/gray-taxi-data/notebooks/02_statistical_analysis.ipynb)